...
var User = _database["default"].model('User');

_passport["default"].use(new _passportJwt.Strategy({
  jwtFromRequest: _passportJwt.ExtractJwt.fromAuthHeaderAsBearerToken(),
  secretOrKey: 'JWT_SECRET'
}, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(payload, done) {
    var user;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            throw new Error('No user that matches id');
...
app.use('/api/batches', _passport["default"].authenticate('jwt', {
  session: false
}), _routes["default"].batches);
